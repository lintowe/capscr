...
impl MainView {
    pub fn view(
        ...
        let screen_tile = Tile::new("[ ]", "Screen").with_sublabel("Full display");
        let window_tile = Tile::new("[=]", "Window").with_sublabel("App window");
        let region_tile = Tile::new("[/]", "Region").with_sublabel("Select area");
        let hdr_tile = Tile::new("[H]", "HDR").with_sublabel("HDR capture");
